(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-calendar-calendar-module~modules-master-data-master-data-module~modules-permissions-permissi~34c7784b"],{
...
var Auth = /** @class */ (function () {
    function Auth(http) {
        this.http = http;
        this.cachedRequests = [];
        this.oAuthUrl = _shared_constants_constant__WEBPACK_IMPORTED_MODULE_1__["BASE_URL"] + '/' + _shared_constants_constant__WEBPACK_IMPORTED_MODULE_1__["ApplicationConstant"].OAUTH_URL;
    }
    Auth.prototype.getUserLoginData = function () {
        if (localStorage.getItem('currentUser') !== null && JSON.parse(localStorage.getItem('currentUser'))) {
            // logged in so return true
            return JSON.parse(localStorage.getItem('currentUser'));
        }
        return false;
    };
    Auth.prototype.unsetUserLoginData = function () {
        localStorage.removeItem('currentUser');
    };
    Auth.prototype.login = function (credentialObj) {
        var params = {
            'grant_type': 'password',
            'client_id': _shared_constants_constant__WEBPACK_IMPORTED_MODULE_1__["ApplicationConstant"].CLIENT_ID,
            'client_secret': _shared_constants_constant__WEBPACK_IMPORTED_MODULE_1__["ApplicationConstant"].CLIENT_SECRET,
            'username': credentialObj.username,
            'password': credentialObj.password,
            'scope': '',
        };
        return this.http.post(this.oAuthUrl, params).toPromise().then(function (data) {
            data['username'] = credentialObj.username;
    ...
    Auth.prototype.refreshToken = function () {
        var currentUser = this.getUserLoginData();
        if (currentUser) {
            var params = {
...
//# sourceMappingURL=modules-calendar-calendar-module~modules-master-data-master-data-module~modules-permissions-permissi~34c7784b.js.map